...
const App = () => {
  ...
  useEffect(() => {
    ...
    AppState.addEventListener('focus', (state) = () => { console.log("focus"); })

    return () => {
      // AppState.removeEventListener('remove');
    };
  }, []);
    ...
    if (isStart) {
      ...
      callDetector = new CallDetectorManager(
        (event, number) => {
          ...
          // For Android event will be either "Offhook", "Disconnected", "Incoming" or "Missed" phoneNumber should store caller/called number
